...
const RELOAD_ICON = `<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>`;
...
export function renderTweaksPanel(adb: Adb): HTMLElement {
  ...
  panel.innerHTML = `
    <div class="tweaks-topbar">
      <div class="tweaks-topbar-title">
        ${SPARKLE_ICON}
        System Tweaks
      </div>
      <button class="tweaks-reload-btn" id="btn-load-tweaks">
        ${RELOAD_ICON}
        Reload
      </button>
    </div>
        ...
        <div class="tweak-card-body">
          ...
          <div class="tweak-card-controls">
            <div class="density-controls">
              <div class="tweak-dropdown" id="dpi-preset">
